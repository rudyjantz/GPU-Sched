...
# 16
if ((i < 512) && (j < 512)) { (C[(i * 512) + j]) = ((A[(i * 512) + j]) + (B[(i * 512) + j])); }  
# 17
} 
#endif
# 19 "MatAdd.cu"
...
# 23
size_t size = ((512 * 512) * sizeof(float)); 
# 25
printf("size: %ld\n", size); 
# 28
for (int i = 0; i < 512; i++) { 
...
# 46
dim3 BlocksPerGrid(512 / 32, 512 / 32); 
# 47
(__cudaPushCallConfiguration(BlocksPerGrid, ThreadsPerBlock)) ? (void)0 : MatAdd(d_A, d_B, d_C); 
# 49
...
# 1 "MatAdd.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__14_MatAdd_cpp1_ii_b3010d62
# 1 "MatAdd.cudafe1.stub.c"
#include "MatAdd.cudafe1.stub.c"
# 1 "MatAdd.cudafe1.stub.c"
