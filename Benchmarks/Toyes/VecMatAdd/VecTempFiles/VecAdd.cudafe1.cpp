...
# 42
dim3 BlocksPerGrid(512 / 32); 
# 43
(__cudaPushCallConfiguration(BlocksPerGrid, ThreadsPerBlock)) ? (void)0 : VecAdd(d_A, d_B, d_C); 
# 45
...
cudaFree(d_C); 
# 56
cudaMalloc(&d_A, (512) * sizeof(float)); 
# 57
cudaMalloc(&d_B, (512) * sizeof(float)); 
# 58
cudaMalloc(&d_C, (512) * sizeof(float)); 
# 60
cudaMemcpy(d_A, A, size, cudaMemcpyHostToDevice); 
# 61
cudaMemcpy(d_B, B, size, cudaMemcpyHostToDevice); 
...
#define _NV_ANON_NAMESPACE _GLOBAL__N__14_VecAdd_cpp1_ii_bb20ad83
# 1 "VecAdd.cudafe1.stub.c"
